...
const RegisterPage = () => {
  ...
  const { loading, error, success, register, clearError, clearSuccess } =
    useAuth();
  ...
  // ── Cleanup errors/success on unmount
  useEffect(() => {
    return () => {
      clearError();
      clearSuccess();
    ...
    <div className="register-page" ref={pageRef}>
      ...
      {success ? (
        ...
        <form className="register-page__form" onSubmit={handleSubmit}>
          ...
          <div className="register-page__field">
            ...
            <div className="register-page__strength">
              <div className="register-page__strength-bars">
                <span
                  className={`register-page__strength-bar ${passwordStrength >= 1 ? "register-page__strength-bar--filled" : ""}`}
                />
                <span
                  className={`register-page__strength-bar ${passwordStrength >= 2 ? "register-page__strength-bar--filled" : ""}`}
                />
                <span
                  className={`register-page__strength-bar ${passwordStrength >= 3 ? "register-page__strength-bar--filled" : ""}`}
                />
                <span
                  className={`register-page__strength-bar ${passwordStrength >= 4 ? "register-page__strength-bar--filled" : ""}`}
                />
              </div>
          ...
          {/* ── Error message */}
          {validationError && <div className="register-page__error">{validationError}</div>}
